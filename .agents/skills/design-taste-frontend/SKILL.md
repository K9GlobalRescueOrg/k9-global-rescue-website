...
## Project Override: K9 Global Rescue

For this repository, apply `.agents/skills/k9gr-design/SKILL.md` and `docs/design-rulebook.md` before using the generic Taste Skill rules below. K9GR should remain serious, credible, operational, global, rescue-focused, and donor-worthy. Do not add generic AI gradients, glassmorphism, fake dashboards, fake stats, fake partners, fake donation links, fake rescue stories, pastel charity styling, public placeholder/review language, unnecessary animation, or gold-heavy low-contrast combinations.
